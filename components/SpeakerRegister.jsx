...
const SpeakerRegister = () => {
  return (
    <div className="flex justify-center items-center mt-20 md:mt-40 h-[60vh] md:bg-gradient-bottom">
      <div className="md:grid grid-cols-2 gap-12 items-center flex flex-col md:-mt-20 md:w-5/6">
          ...
          <div className="flex flex-col gap-12 text-base md:p-0 md:text-left text-center md:mx-auto w-full ">
            ...
            <div className="flex flex-col">
              <div className="md:text-lg flex flex-col gap-4 text-base md:leading-8 mt-5 md:text-left text-center">
                ...
                <p>{`
This could be your chance! We're seeking speakers from diverse domains such as UI/UX, System Design, Product Management, Developer Relations, Machine Learning, and more. Our vision is simple: learn, grow, and give back. If you resonate with these principles, join us at CareerConf.`}</p>
              </div>
              <Link
